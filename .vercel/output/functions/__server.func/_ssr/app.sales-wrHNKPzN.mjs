...
import { N as NewSaleDialog, B as Badge } from "./transaction-dialog-kSN8oKo_.mjs";
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("sales").select("*").order("sale_date", {
        ascending: false
      }).order("created_at", {
        ascending: false
      });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 sm:flex sm:flex-wrap sm:items-end sm:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight sm:text-3xl", children: t("sales.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground sm:text-base", children: t("sales.subtitle") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ExportMenu, { spec: () => ({
          ...
          body: sales.map((s) => [s.sale_date, s.invoice_no, s.payment_method, Number(s.total) - Number(s.paid) < 0.01 ? "Lunas" : "Piutang", s.due_date ?? "", Number(s.total), Number(s.paid), Math.max(0, Number(s.total) - Number(s.paid))]),
          cols: [12, 16, 10, 10, 14, 14, 14, 14],
          totalRow: ["TOTAL", "", "", "", "", sales.reduce((sum, s) => sum + Number(s.total), 0), sales.reduce((sum, s) => sum + Number(s.paid), 0), sales.reduce((sum, s) => sum + Math.max(0, Number(s.total) - Number(s.paid)), 0)]
        }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: setOpen, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "gap-2", children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Penjualan Baru" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Baru" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(NewSaleDialog, { userId: user.id, onClose: () => {
            setOpen(false);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0 sm:p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "hidden sm:table-cell", children: "Pembayaran" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: sales.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 7, className: "py-8 text-center text-muted-foreground", children: "Belum ada transaksi penjualan." }) }) : sales.map((s) => {
        const lunas = Number(s.total) - Number(s.paid) < 0.01;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "whitespace-nowrap text-xs sm:text-sm", children: s.sale_date }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: s.invoice_no }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "hidden capitalize sm:table-cell", children: s.payment_method }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: lunas ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "bg-emerald-100 text-emerald-700", children: "Lunas" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: "Piutang" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "hidden whitespace-nowrap md:table-cell", children: s.due_date ?? "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right font-semibold whitespace-nowrap", children: idr(s.total) }),
